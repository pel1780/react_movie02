...
const GenreMovie = ({ genre, on, setOn }) => {
...
const Movie = () => {
    ...
    const GL = [
        "Action", "Adventure", "Animation", "Music", "War"
    ]
    ...
    if (load) {
        return <Load><i class="xi-spinner-3 xi-spin"></i></Load>
    }
    ...
    return (
        <Wapper>
            ...
            <Header>
                <H1>
                    <a href="/react_movie02/">Lee's Movie</a>
                </H1>
            ...
            {
                GL.map((it, idx) => <GenreMovie genre={it} on={on} setOn={setOn} key={idx} />)
            }
            <Footer>&copy; kim</Footer>
        </Wapper>
    )
}
